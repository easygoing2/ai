        ...
        <div class="resWidth">
            ...
            <div class="footerContent" data-section="footerSection">
                <div class="footerBrand">
                    <div class="logo"><i class='bx <?php echo $theme_logo_icon; ?>' data-item="logoIcon"></i> <strong data-item="logoTxt"><?php echo $theme_logo_text; ?></strong></div>
                    <div class="footerCopyright">
                        <p>Copyright © 2025 <?php echo $theme_logo_text; ?>. All rights reserved</p>
                    </div>
                </div>

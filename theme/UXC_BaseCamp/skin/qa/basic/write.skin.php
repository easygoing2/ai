            ...
            <div class="boardWriteBody">
                ...
                <div class="writeBox bg-wh round-m padding-m">
                    ...
                    <div class="item">
                        ...
                        <input type="text" name="qa_subject" value="<?php echo get_text($write['qa_subject']); ?>" id="qa_subject" required class="required" maxlength="255" placeholder="제목을 입력하세요">        
                    </div>
                    ...
                    <div class="item">
                        ...
                        <input type="text" name="qa_email" value="<?php echo get_text($write['qa_email']); ?>" id="qa_email" <?php echo $req_email; ?> class="<?php echo $req_email.' '; ?>email" maxlength="100" placeholder="이메일 주소">
                        <div class="opt" style="margin-top: 8px;">
                            <input type="checkbox" name="qa_email_recv" id="qa_email_recv" value="1" <?php if($write['qa_email_recv']) echo 'checked="checked"'; ?> class="magic-checkbox">
                    ...
                    <div class="item">
                        ...
                        <input type="text" name="qa_hp" value="<?php echo get_text($write['qa_hp']); ?>" id="qa_hp" <?php echo $req_hp; ?> class="<?php echo $req_hp; ?>" placeholder="휴대폰 번호">
                        <?php if($qaconfig['qa_use_sms']) { ?>
                        <div class="opt" style="margin-top: 8px;">
                            <input type="checkbox" name="qa_sms_recv" id="qa_sms_recv" value="1" <?php if($write['qa_sms_recv']) echo 'checked="checked"'; ?> class="magic-checkbox">
                ...
                <div class="insertBox bg-wh round-m padding-m">
                    ...
                    <div class="item file">
                        ...
                        <div class="fileDel" style="padding-top: 8px;">
                            ...
                            <label for="bf_file_del2"><span class="text" style="color:#ff6666"><?php echo $write['qa_source2']; ?></span> 파일 삭제</label>
                        </div>
                        <?php } ?>
                    </div>

...
<div class="uxc_gallery" data-latest="uxc_gallery">
    <ul>
    <?php
    ...
    ?>
        <li class="uxc_gallery_li">
            <a href="<?php echo get_pretty_url($item_bo_table, $list[$i]['wr_id']) ?>" class="lt_img"><?php echo $img_content; ?></a>
            <?php
            // 멀티 게시판 지원: 위에서 정의한 item_bo_table 사용
            echo "<a href=\"".get_pretty_url($item_bo_table, $list[$i]['wr_id'])."\">";

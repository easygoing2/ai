        ...
        <div class="listBox" data-board="webzine_list">
            ...
            <div class="cardBox <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php if ($wr_id == $list[$i]['wr_id']) echo "active"; ?>">
                ...
                <div class="titleBox">
                    ...
                    <?php } ?>
                    <div href="<?php echo $list[$i]['href'] ?>" class="thumb">
                        <img src="<?php echo $img_content ?>" title="thumb" class="round-m" loading="lazy" onerror="this.onerror=null;this.src='<?php echo $board_skin_url ?>/img/no_img.png'">
                        <?php if ($list[$i]['wr_10']) { ?>
            ...
            <!-- empty -->
            <?php if (count($list) == 0) { echo '<div class="cardBox bg-wh line-de padding-l round-m mt10">게시물이 없습니다.</div>'; } ?>

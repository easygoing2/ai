    ...
    <form name="fviewcomment" id="fviewcomment" action="<?php echo $comment_action_url; ?>" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off">
        ...
        <div class="commentBox">
            ...
            <div class="textWriter">
                ...
                <textarea id="wr_content" name="wr_content" maxlength="10000" required class="bg-wh color-bl line-de round-m" title="내용" placeholder="댓글내용을 입력해주세요" <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');" <?php } ?>><?php echo $c_wr_content; ?></textarea>

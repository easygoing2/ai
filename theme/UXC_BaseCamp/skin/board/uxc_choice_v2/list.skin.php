...
<div class="boardListWrap">
    ...
    <div class="toolBox">
        <div class="tools">
            ...
            <div class="total">
                ...
                <span><strong><?php echo (int)$page ?></strong> 페이지</span>
            </div>
        </div>
        <!-- tools -->
        <div class="tools">
    ...
    <div class="listWrap">
        ...
        <div class="listBox" data-board="uxc_choice">
            <!-- 테이블 헤더 -->
                ...
                <div class="col col-subject">
                    <div class="bo_tit">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>">
                            <?php if ($has_chosen) { ?>
                            <span class="chosen-icon"><i class='bx bxs-badge-check'></i> 채택</span>
                            <?php } ?>
                            ...
                            if ($is_category && $list[$i]['ca_name']) {
                                echo '<span class="bo_cate_link">'.$list[$i]['ca_name'].'</span>';
                            }
                            ?>

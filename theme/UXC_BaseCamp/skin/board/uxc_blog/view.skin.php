            ...
            <div class="info">
                ...
                <div class="pfData">
                    ...
                    <div class="postData">
                        ...
                        <span><i class='bx bx-message-square-dots'></i> <?php echo number_format($view['wr_comment']) ?>건</a></span>
            ...
            <div class="viewContentBox">
                ...
                <div class="viewContText">
                    ...
                    <?php if($is_markdown) { ?>
                        ...
                        <div id="bo_v_con" 
                             class="content toastui-editor-contents" 
                             data-markdown="<?php echo htmlspecialchars($markdown_content); ?>"
                             style="min-height: 300px;">
                            <!-- 로딩 표시 -->
                            <div class="markdown-loading" style="padding:20px;text-align:center;color:#999;">

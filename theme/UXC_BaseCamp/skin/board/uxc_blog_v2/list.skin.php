    ...
    <div class="listWrap">
        ...
        <div class="listBox" data-board="uxc_blog">
            ...
            for ($i=0; $i<count($list); $i++) {
                // 썸네일 이미지 추출
                $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], 600, 400, false, true);
            ...
            <article class="blog-card <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php if ($wr_id == $list[$i]['wr_id']) echo "active"; ?>">
                ...
                <div class="card-header">
                    ...
                    <div class="blog-meta">
                        ...
                        <span class="meta-category">
                            ...
                            <?php echo htmlspecialchars($list[$i]['ca_name'], ENT_QUOTES, 'UTF-8') ?>
                        </span>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="blog-thumbnail">
                        <img src="<?php echo htmlspecialchars($thumb['src'], ENT_QUOTES, 'UTF-8') ?>" alt="<?php echo $list[$i]['subject'] ?>" style="max-width:600px;width:100%;height:auto;">
                    </div>
                    <?php } ?>
                    <?php
                    // 유튜브 영상 처리

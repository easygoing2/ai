...
<div class="searchBoxWrap">
    ...
    <fieldset class="searchFormBox">
        ...
        <div class="inputWrap">
            <input type="text" name="stx" value="<?php echo $text_stx ?>" id="stx" required placeholder="검색어를 입력하세요" size="40">
        </div>
        <button type="submit" class="button bg-pr color-wh-only round-s mBtn">검색</button>
        ...
        <div class="optBox">
            <div class="opt">
                ...
                <label for="sop_and"><span class="text">AND</span></label>
            </div>
            <div class="opt">
                <input type="radio" value="or" <?php echo ($sop == "or") ? "checked" : ""; ?> id="sop_or" name="sop" >
                <label for="sop_or"><span class="text">OR</span></label>
            </div>
        </div>
    </fieldset>
    </form>
    ...
    <div class="searchWrap">
        ...
        <section class="searchInfo">
            <h3><strong>'<?php echo $stx ?>'</strong> 전체검색 결과</h3>
            <ul>
        ...
        <?php if ($stx && $board_count) { ?><section class="searchListWrap"><?php }  ?>
        <?php
        $k=0;
                ...
                ?>
                    ...
                    <li>
                        ...
                        <p><?php 
                            ...
                            $content = preg_replace('/!\[[^\]]*\]\([^)]+\)/', '', $list[$idx][$i]['content']);
                            echo $content;
                        ?></p>
                        <div class="sch_info">
                            <span class="sch_author"><?php echo $list[$idx][$i]['name'] ?></span>

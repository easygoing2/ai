        ...
        while ($row2 = sql_fetch_array($result2))
        {
            ...
            $sql = " insert into $move_write_table
                        set wr_num = " . ($next_wr_num ? "'$next_wr_num'" : "(SELECT IFNULL(MIN(wr_num) - 1, -1) FROM $move_write_table as sq) ") . ",
                             ...
                             wr_link3 = '".addslashes($row2['wr_link3'])."',
                             wr_link4 = '".addslashes($row2['wr_link4'])."',
                             wr_link5 = '".addslashes($row2['wr_link5'])."',
                             wr_link1_hit = '{$row2['wr_link1_hit']}',
                             wr_link2_hit = '{$row2['wr_link2_hit']}',
                             wr_link3_hit = '{$row2['wr_link3_hit']}',
                             wr_link4_hit = '{$row2['wr_link4_hit']}',
                             wr_link5_hit = '{$row2['wr_link5_hit']}',
                             wr_hit = '{$row2['wr_hit']}',
                             wr_good = '{$wr_good}',
                             wr_nogood = '{$wr_nogood}',
                             mb_id = '{$row2['mb_id']}',

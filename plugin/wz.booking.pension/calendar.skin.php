...
$sch_year = isset($_GET['sch_year']) ? (int)$_GET['sch_year'] : '';
$sch_month = isset($_GET['sch_month']) ? (int)$_GET['sch_month'] : '';
$sch_day = isset($sch_day) ? $sch_day : '';
    ...
    for ($day = 1; $day <= $total_day; $day++) {
        ...
        if ($cnt_room > 0 && !$is_block) { 
            ...
            for ($j=0;$j<$cnt_room;$j++) { 
                $nw_status = '';
                if (isset($arr_status[$vDate][$arr_room[$j]['rm_ix']]['rms_status']))

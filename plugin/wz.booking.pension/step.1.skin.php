...
$sch_year = '';
$sch_month = '';
$rm_ix = isset($_GET['rm_ix']) ? (int)$_GET['rm_ix'] : 0;
...
$requested_sch_day = isset($_GET['sch_day']) ? $_GET['sch_day'] : '';
$sch_day = preg_match("/^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})$/", $requested_sch_day) ? $requested_sch_day : WZP_DEFAULT_TODAY;
...
<div class="st1-header">
    ...
    <div class="st1-left">
        ...
        <div class="cal_navi">
            <a class="cal_navi_btn" href="javascript:getCalender('<?php echo $year_prev?>','<?php echo $month_prev?>','<?php echo $sch_day?>');" aria-label="이전 달">
                <span class="btn_reserve_prev" aria-hidden="true">&lt;</span>
            </a>
            <strong class="title_red">
                <span><?php echo $sch_year?>년</span>
                <span><?php echo $sch_month_02d?>월</span>
            </strong>
            <a class="cal_navi_btn" href="javascript:getCalender('<?php echo $year_next?>','<?php echo $month_next?>','<?php echo $sch_day?>');" aria-label="다음 달">
                <span class="btn_reserve_next" aria-hidden="true">&gt;</span>
            </a>
        </div>

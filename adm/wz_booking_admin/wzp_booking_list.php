...
<select name="sfl" id="sfl">
    <option value="bk_name"<?php echo get_selected($sfl, "bk_name"); ?>>예약자명</option>
    <option value="bk_hp"<?php echo get_selected($sfl, "bk_hp"); ?>>핸드폰</option>
    <option value="bk_email"<?php echo get_selected($sfl, "bk_email"); ?>>이메일</option>
    <option value="bk_memo"<?php echo get_selected($sfl, "bk_memo"); ?>>요청사항</option>
    <option value="mb_id"<?php echo get_selected($sfl, "mb_id"); ?>>예약자아이디</option>
</select>
